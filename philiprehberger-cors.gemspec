...
Gem::Specification.new do |spec|
  ...
  spec.metadata['source_code_uri']       = 'https://github.com/philiprehberger/rb-cors'
  spec.metadata['changelog_uri']         = 'https://github.com/philiprehberger/rb-cors/blob/main/CHANGELOG.md'
  spec.metadata['bug_tracker_uri']       = 'https://github.com/philiprehberger/rb-cors/issues'
